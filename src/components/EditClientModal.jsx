            ...
            <div className="grid2col mb-7">
              ...
              <div className='flexColumn'>
                ...
                <label className="text-neutral-800">
                  ...
                  <input type="text" name="fairs" value={formData.fairs} onChange={handleChange} readOnly={readOnly}/>
                </label>

                <label className="text-neutral-800">
                  {t('addClientModal.competition')}<br />
                  <input type="text" name="competition" value={formData.competition} onChange={handleChange} readOnly={readOnly}/>
                </label>
